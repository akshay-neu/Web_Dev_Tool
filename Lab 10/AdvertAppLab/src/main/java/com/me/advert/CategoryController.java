...
public class CategoryController {
	...
	public String handleCategoryForm(@ModelAttribute("category") Category category, BindingResult result, 
                SessionStatus status, CategoryDAO categorydao) throws AdvertException { 
            // injected categorydao instance in the handler method
		if (result.hasErrors())
			return "addCategoryForm";
		else {
