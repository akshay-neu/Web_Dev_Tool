...
<%
	...
	//com.me.dao.CategoryDAO categorydao = new com.me.dao.CategoryDAO();
...
<body>
	...
	<form:form modelAttribute="advert" method="post">
		...
		<table>
			...
			<tr>
				<td>Message:</td>
				<td><form:input path="message" size="30" /> <font color="red"><form:errors
							path="message" /></font></td>
			</tr>

			<tr>
				<td>Advert Posted By:</td>
				<td><form:input path="postedBy" size="30" /> <font color="red"><form:errors
