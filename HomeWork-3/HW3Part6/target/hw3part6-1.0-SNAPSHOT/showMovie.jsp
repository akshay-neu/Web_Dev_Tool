...
<html>
    ...
    <body style="background-color: greenyellow">
        ...
        <c:forEach var="movie" items="${requestScope.resultArrayList}">
            ...
            <tr>
                <td>Lead Actor:</td>
                <td><td><c:out value="${movie.getActor()}"/></td></td>
            </tr>
            <tr>
                <td>Lead Actress:</td>
                <td><td><c:out value="${movie.getActress()}"/></td></td>
            </tr>
            <tr>
                <td>Genre:</td>
                <td><td><c:out value="${movie.getGenre()}"/></td></td>
            </tr>
            <tr>
                <td>Year</td>
                <td><td><c:out value="${movie.getYear()}"/></td></td>
            </tr>
        </c:forEach>
        </table>
